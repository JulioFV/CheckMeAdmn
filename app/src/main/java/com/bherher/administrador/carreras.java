...
import com.bherher.administrador.adapter.AdapterCarrera;
...
public class carreras extends Fragment {
     ...
     * @return A new instance of fragment carreras.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        rec=view.findViewById(R.id.frg_recycler_carrera);
    ...
    private ArrayList<MCarrera> llenadoDesdeBD() {
        ArrayList<MCarrera> lista=new ArrayList<MCarrera>();
        ...
        StringRequest solicitud= new StringRequest(Request.Method.POST, API.LISTAR_CARRERA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //adapter=new AdapterCarrera(lista);
